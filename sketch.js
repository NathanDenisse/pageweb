...
function setup() {
  canvas = createCanvas(LARGEUR, HAUTEUR-50);
  ...
  start = createSprite(LARGEUR * 0.15, HAUTEUR * 0.55 - 75, 20, 20);
  start.addImage(startImg);
  start.scale = 0.1;
  vaisseau.visible = false;
  fleche = createSprite(LARGEUR * 0.15, HAUTEUR * 0.55 - 175);
...
function draw() {
  ...
  if (statut === "gameOver") {
    ...
    textSize(60);
    fill("RED");
    text("GAME OVER", LARGEUR / 2 - 180, HAUTEUR*0.2);
